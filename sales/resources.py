...
class QuoteResource(resources.ModelResource):
    ...
    class Meta:
        ...
        fields = (
            ...
            'customer', 'total_amount', 'tax_rate', 'tax_amount',
            'status', 'notes',
...
class SalesOrderResource(resources.ModelResource):
    ...
    class Meta:
        ...
        fields = (
            ...
            'customer', 'quote', 'total_amount', 'tax_rate', 'tax_amount',
            'status', 'notes',
            'created_at', 'updated_at'
        )
        export_order = fields
...
class SalesReturnResource(resources.ModelResource):
    ...
    class Meta:
        ...
        fields = (
            ...
            'sales_order', 'customer', 'total_amount',
            'return_reason', 'status', 'notes',
            'created_at', 'updated_at'
        )
        export_order = fields
...
class SalesLoanResource(resources.ModelResource):
    ...
    class Meta:
        model = SalesLoan
        fields = (
            'id', 'loan_number', 'loan_date', 'expected_return_date', 'actual_return_date',
