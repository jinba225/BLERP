...
def translate_text(text: str, target_language: str, translator_type: str = 'baidu',
...
def translate_product_data(product_data: Dict[str, any], target_language: str,
                          translator_type: str = 'baidu') -> Dict[str, any]:
    """
    翻译产品数据
