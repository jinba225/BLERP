...
class WarehouseAdmin(ImportExportModelAdmin):
    ...
    fieldsets = (
        ("基本信息", {"fields": ("name", "code", "warehouse_type", "address")}),
        ("管理信息", {"fields": ("manager", "phone", "capacity")}),
        ("状态", {"fields": ("is_active",)}),
        (
            "系统信息",
            {
...
class StockCountAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("基本信息", {"fields": ("count_number", "count_type", "warehouse", "status")}),
        ("日期信息", {"fields": ("planned_date", "start_date", "end_date")}),
        ("人员信息", {"fields": ("supervisor", "counters")}),
        ("其他信息", {"fields": ("notes",)}),
        (
            "系统信息",
            {
