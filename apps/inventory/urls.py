...
urlpatterns = [
    ...
    path(
        "warehouses/<int:warehouse_pk>/locations/create/",
    ...
    path(
        ...
        name="report_stock_transaction",
    ),
    path("reports/stock-alert/", views.stock_alert_report, name="report_stock_alert"),
    path(
        "reports/inbound-outbound-statistics/",
        views.inbound_outbound_statistics,
        name="report_inbound_outbound_statistics",
    ),
