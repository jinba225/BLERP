...
from apps.logistics.models import LogisticsCompany, ShippingOrder, TrackingInfo, LogisticsCost
...
class ShippingOrderModelTest(TestCase):
    ...
    def test_shipping_order_status_choices(self):
        """测试物流订单状态选项"""
        valid_statuses = ['pending', 'shipped', 'in_transit', 'out_for_delivery', 
...
class LogisticsCostModelTest(TestCase):
    ...
    def test_logistics_cost_type_choices(self):
        """测试物流成本类型选项"""
        valid_types = ['freight', 'fuel_surcharge', 'remote_area_fee', 
                      'cod_fee', 'insurance', 'package_fee', 'other']
