...
from apps.bi.models import (
    Report, ReportData, Dashboard, DashboardWidget,
    SalesSummary, ProductSales, InventoryAnalysis, PlatformComparison
)
...
class TestBIModels:
    ...
    def test_create_dashboard(self):
        ...
        user = User.objects.create_user(
            username='testuser_bi',
            email='test_bi@example.com',
