...
class QuoteAdmin(ImportExportModelAdmin):
    ...
    fieldsets = (
        ...
        ("条款", {"fields": ("payment_terms", "delivery_terms", "warranty_terms")}),
        ("其他信息", {"fields": ("reference_number", "notes", "converted_order")}),
        (
            "系统信息",
            {
...
class SalesLoanAdmin(ImportExportModelAdmin):
    ...
    fieldsets = (
        ("基本信息", {"fields": ("loan_number", "customer", "salesperson", "status")}),
