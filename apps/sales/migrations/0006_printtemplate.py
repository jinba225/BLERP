    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_type', models.CharField(choices=[('quote_domestic', '报价单-国内'), ('quote_overseas', '报价单-海外'), ('sales_order', '销售订单'), ('purchase_order', '采购订单')], max_length=20, verbose_name='模板类型')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['template_type', 'is_active'], name='sales_print_templat_67c3a5_idx'), models.Index(fields=['is_default', 'is_active'], name='sales_print_is_defa_9ba899_idx')],
            },
        ),
    ]
