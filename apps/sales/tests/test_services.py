...
from apps.sales.services.business import QuoteService, OrderService
from apps.sales.models import Quote, QuoteItem, SalesOrder, SalesOrderItem, Delivery, DeliveryItem
...
class QuoteServiceTestCase(SalesServiceTestCaseBase):
    ...
    def test_create_quote_with_custom_number(self):
        ...
        items_data = [
            {'product': self.product1, 'quantity': Decimal('1'), 'unit_price': Decimal('100000.00'), 'tax_rate': Decimal('0.13')},
        ]
...
class OrderServiceTestCase(SalesServiceTestCaseBase):
    ...
    def test_create_order_basic(self):
        ...
        items_data = [
            {'product': self.product1, 'quantity': Decimal('2'), 'unit_price': Decimal('100000.00')},
    ...
    def test_update_order_basic(self):
        ...
        items_data = [{'product': self.product1, 'quantity': Decimal('1'), 'unit_price': Decimal('100000.00')}]
        order = OrderService.create_order(self.user, order_data, items_data)
