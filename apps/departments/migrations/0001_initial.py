    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personnel_budget', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='人员预算')),
                ('operational_budget', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='运营预算')),
                ('equipment_budget', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='设备预算')),
                ('other_budget', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='其他预算')),
                ('personnel_actual', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='人员实际')),
                ('operational_actual', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='运营实际')),
                ('equipment_actual', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='设备实际')),
                ('other_actual', models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='其他实际')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('junior', '初级'), ('intermediate', '中级'), ('senior', '高级'), ('expert', '专家'), ('manager', '经理'), ('director', '总监'), ('vp', '副总裁'), ('president', '总裁')], default='junior', max_length=20, verbose_name='职位级别')),
