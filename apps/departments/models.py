...
class DepartmentBudget(BaseModel):
    ...
    def total_budget(self):
        ...
        return (self.personnel_budget + self.operational_budget + 
                self.equipment_budget + self.other_budget)

    @property
    def total_actual(self):
        """Calculate total actual amount."""
        return (self.personnel_actual + self.operational_actual + 
                self.equipment_actual + self.other_actual)
