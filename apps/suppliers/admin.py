...
class SupplierAdmin(ImportExportModelAdmin):
    ...
    fieldsets = (
        ("基本信息", {"fields": ("name", "code", "category", "level")}),
        ("联系信息", {"fields": ("website",)}),
        (
            "地址信息",
            {
        ...
        ("采购信息", {"fields": ("buyer", "lead_time", "min_order_amount")}),
        (
            "质量与评级",
            {
                "fields": (
        ...
        ("状态设置", {"fields": ("is_active", "is_approved", "notes")}),
        (
            "系统信息",
            {
                "fields": (
...
class SupplierEvaluationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("评价内容", {"fields": ("strengths", "weaknesses", "recommendations")}),
        ("评估结果", {"fields": ("is_approved", "evaluator")}),
        (
            "系统信息",
            {
                "fields": ("created_at", "updated_at", "created_by", "updated_by"),
