...
class Supplier(BaseModel):
    ...
    quality_rating = models.DecimalField(
        "质量评级", max_digits=3, decimal_places=1, default=0, help_text="0-10分"
    )
    delivery_rating = models.DecimalField(
        "交货评级", max_digits=3, decimal_places=1, default=0, help_text="0-10分"
    )
    service_rating = models.DecimalField(
        "服务评级", max_digits=3, decimal_places=1, default=0, help_text="0-10分"
    )
    ...
    def total_purchase_amount(self):
        ...
        return self.purchase_orders.aggregate(total=Sum("total_amount"))["total"] or 0
...
class SupplierEvaluation(BaseModel):
    ...
    evaluator = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, verbose_name="评估人"
    )
