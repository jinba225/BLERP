...
class ProductCategoryAdmin(ImportExportModelAdmin, MPTTModelAdmin):
    ...
    fieldsets = (
        ("基本信息", {"fields": ("name", "code", "parent", "description")}),
        ("显示设置", {"fields": ("image", "sort_order", "is_active")}),
        (
            "系统信息",
            {
...
class BrandAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("品牌详情", {"fields": ("logo", "website", "country")}),
        ("状态", {"fields": ("is_active",)}),
        (
            "系统信息",
            {
...
class UnitAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("基本信息", {"fields": ("name", "symbol", "unit_type", "description")}),
        ("状态", {"fields": ("is_active",)}),
        (
            "系统信息",
            {
...
class ProductPriceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("基本信息", {"fields": ("product", "price_type", "price")}),
        ("生效日期", {"fields": ("effective_date", "end_date", "is_active")}),
        ("调价说明", {"fields": ("reason",)}),
        (
            "系统信息",
            {
