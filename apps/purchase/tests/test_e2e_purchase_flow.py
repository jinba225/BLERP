...
def create_inventory_transaction(product, warehouse, quantity, transaction_type, reference_type, reference_id, reference_number, operator):
    """辅助函数：创建库存事务记录"""
