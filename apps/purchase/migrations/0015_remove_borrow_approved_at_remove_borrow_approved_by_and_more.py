...
class Migration(migrations.Migration):
    dependencies = [
        ...
        (
            "purchase",
            "0014_remove_borrow_approved_at_remove_borrow_approved_by_and_more",
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="purchase_or_platfor_16117d_idx",
                    ),
                    models.Index(
                    ...
                    models.Index(
                        ...
                        name="purchase_or_last_sy_af33a4_idx",
                    ),
                    models.Index(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="purchase_sy_status_c18919_idx",
                    ),
                    models.Index(
                        fields=["platform", "status"],
                        name="purchase_sy_platfor_d24f18_idx",
                    ),
                    models.Index(
                        fields=["sync_type", "status"],
                        name="purchase_sy_sync_ty_79fe29_idx",
                    ),
