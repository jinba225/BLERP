...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('purchase', '0014_remove_borrow_approved_at_remove_borrow_approved_by_and_more'),
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='invoice',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='purchase_orders', to='finance.invoice', verbose_name='关联发票'),
        ),
        migrations.AddField(
            model_name='purchaseorder',
            name='invoiced_at',
        ...
        migrations.AddField(
            model_name='purchaseorder',
            name='invoiced_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invoiced_orders', to=settings.AUTH_USER_MODEL, verbose_name='开票人'),
        ),
        migrations.AddField(
            model_name='purchaseorder',
            name='last_synced_at',
        ...
        migrations.AddField(
            ...
            name='credit_note',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='purchase_returns', to='finance.invoice', verbose_name='红字发票'),
        ),
        ...
        migrations.AlterField(
            model_name='purchaseorder',
            name='status',
            field=models.CharField(choices=[('draft', '草稿'), ('approved', '已审核'), ('partial_received', '部分收货'), ('fully_received', '全部收货'), ('invoiced', '已开票'), ('paid', '已付款'), ('cancelled', '已取消')], default='draft', max_length=20, verbose_name='订单状态'),
        ),
        migrations.AlterField(
            model_name='purchaseorder',
            name='tax_rate',
