...
class AccountModelTest(TestCase):
    ...
    def test_account_full_name(self):
        ...
        parent = Account.objects.create(
            code="1000", name="资产", account_type="asset", created_by=self.user
        )
    ...
    def test_account_str_representation(self):
        ...
        account = Account.objects.create(
            code="1001", name="库存现金", account_type="asset", created_by=self.user
        )
...
class BudgetLineModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.account = Account.objects.create(
            code="6001", name="销售费用", account_type="expense", created_by=self.user
        )
