    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='预付金额')),
                ('balance', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='剩余余额')),
                ...
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prepayments', to='suppliers.supplier', verbose_name='供应商')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(default=False, verbose_name='是否删除')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='删除时间')),
                ('amount', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='预收金额')),
                ('balance', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='剩余余额')),
                ('currency', models.CharField(default='CNY', max_length=10, verbose_name='币种')),
                ('received_date', models.DateField(verbose_name='收到日期')),
                ('notes', models.TextField(blank=True, verbose_name='备注')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL, verbose_name='创建人')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prepayments', to='customers.customer', verbose_name='客户')),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_deleted', to=settings.AUTH_USER_MODEL, verbose_name='删除人')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated', to=settings.AUTH_USER_MODEL, verbose_name='更新人')),
            ],
            options={
