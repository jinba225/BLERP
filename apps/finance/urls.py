...
urlpatterns = [
    ...
    path(
        ...
        views.customer_account_writeoff,
        name="customer_account_writeoff",
    ),
    path(
        "customer-accounts/<int:pk>/available-prepays/",
        views.api_customer_account_available_prepays,
        name="api_customer_account_available_prepays",
    ),
    # Supplier Accounts
    ...
    path(
        ...
        views.generate_supplier_account_from_invoice,
        name="generate_supplier_account_from_invoice",
    ),
    path(
        "supplier-accounts/<int:pk>/writeoff/",
        views.supplier_account_writeoff,
        name="supplier_account_writeoff",
    ),
    path(
        "supplier-accounts/<int:pk>/available-prepays/",
        views.api_supplier_account_available_prepays,
        name="api_supplier_account_available_prepays",
    ),
    path(
        "supplier-accounts/payment/",
        views.supplier_account_payment_list,
        name="supplier_account_payment_list",
    ),
    path(
        "supplier-accounts/payment/<int:pk>/allocate/",
        views.supplier_account_payment_allocate,
        name="supplier_account_payment_allocate",
    ),
    # Payments
    ...
    path(
        ...
        name="payment_receipt_update",
    ),
    path(
        "payment-receipts/<int:pk>/delete/",
        views.payment_receipt_delete,
        name="payment_receipt_delete",
    ),
    path(
        "payment-receipts/<int:pk>/cancel/",
        views.payment_receipt_cancel,
        name="payment_receipt_cancel",
    ),
    # 付款记录
    ...
    path(
        ...
        name="payment_payment_update",
    ),
    path(
        "payment-payments/<int:pk>/delete/",
        views.payment_payment_delete,
        name="payment_payment_delete",
    ),
    path(
        "payment-payments/<int:pk>/cancel/",
        views.payment_payment_cancel,
        name="payment_payment_cancel",
    ),
    # 发票
    ...
    path(
        "invoices/create-from-sales-order/<int:order_id>/",
        views.invoice_create_from_sales_order,
        name="invoice_create_from_sales_order",
    ),
    # 税率
    ...
    path(
        ...
        name="customer_prepayment_create",
    ),
    path(
        "prepayments/customer/<int:pk>/edit/",
        views.customer_prepayment_edit,
        name="customer_prepayment_edit",
    ),
    path(
        "prepayments/customer/<int:pk>/delete/",
        views.customer_prepayment_delete,
        name="customer_prepayment_delete",
    ),
    path(
        "prepayments/customer/consolidate/<int:customer_id>/",
    ...
    path(
        ...
        name="supplier_prepayment_create",
    ),
    path(
        "prepayments/supplier/manage/<int:supplier_id>/",
        views.supplier_prepayment_manage,
        name="supplier_prepayment_manage",
    ),
    path(
        "prepayments/supplier/<int:pk>/edit/",
        views.supplier_prepayment_edit,
        name="supplier_prepayment_edit",
    ),
    path(
        "prepayments/supplier/<int:pk>/delete/",
        views.supplier_prepayment_delete,
        name="supplier_prepayment_delete",
    ),
    path(
        "prepayments/supplier/consolidate/<int:supplier_id>/",
    ...
    # 财务报表生成器
    path(
        "reports/generate/balance-sheet/",
        views_reports.generate_balance_sheet,
        name="generate_balance_sheet",
    ),
    path(
        "reports/generate/income-statement/",
        views_reports.generate_income_statement,
    ...
    path(
        ...
        views_reports.generate_trial_balance,
