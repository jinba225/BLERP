...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--dry-run", action="store_true", help="Run migration without saving data"
        )
        parser.add_argument(
            "--module",
            type=str,
    ...
    def migrate_users(self):
        ...
        if not os.path.exists(users_file):
            self.stdout.write(self.style.WARNING("Users file not found, skipping..."))
            return
    ...
    def migrate_departments(self):
        ...
        if not os.path.exists(dept_file):
            self.stdout.write(self.style.WARNING("Departments file not found, skipping..."))
            return
    ...
    def migrate_customers(self):
        ...
        if not os.path.exists(customers_file):
            self.stdout.write(self.style.WARNING("Customers file not found, skipping..."))
            return
    ...
    def migrate_suppliers(self):
        ...
        if not os.path.exists(suppliers_file):
            self.stdout.write(self.style.WARNING("Suppliers file not found, skipping..."))
            return
    ...
    def migrate_products(self):
        ...
        if not os.path.exists(products_file):
            self.stdout.write(self.style.WARNING("Products file not found, skipping..."))
            return
                    ...
                    if row.get("base_unit_symbol"):
                        try:
                            ...
                            base_unit = Unit.objects.create(
                                name="个", symbol="个", unit_type="quantity"
                            )
