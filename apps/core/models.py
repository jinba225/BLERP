...
class Company(BaseModel):
    ...
    description_en = models.TextField(
        "Company Description (English)", blank=True, help_text="英文公司描述"
    )
...
class Notification(models.Model):
    ...
    notification_type = models.CharField(
        "通知类型", max_length=20, choices=NOTIFICATION_TYPES, default="info"
    )
    category = models.CharField(
        "分类", max_length=30, choices=NOTIFICATION_CATEGORIES, default="system"
    )
