...
urlpatterns = [
    ...
    path('print-templates/<int:pk>/delete/', tpl_views.template_delete, name='print_template_delete'),
    path('print-templates/<int:pk>/preview/', tpl_views.template_preview, name='print_template_preview'),
    path('print-templates/<int:pk>/set-default/', tpl_views.template_set_default, name='print_template_set_default'),
    path('print-templates/<int:pk>/duplicate/', tpl_views.template_duplicate, name='print_template_duplicate'),
    ...
    path('print-templates/<int:pk>/update-category/', tpl_views.template_update_category, name='print_template_update_category'),
