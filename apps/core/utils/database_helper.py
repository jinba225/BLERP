...
class DatabaseHelper:
    ...
    def clear_test_data():
        ...
        try:
            ...
            from apps.products.models import Product, Unit, Brand, ProductCategory
            from apps.sales.models import SalesOrder, Quote, Delivery, SalesReturn
            from apps.purchase.models import PurchaseRequest, PurchaseRequestItem, PurchaseOrder, PurchaseReturn, PurchaseInquiry, PurchaseReceipt, Borrow
            from apps.finance.models import CustomerAccount, SupplierAccount, TaxRate, Journal, FinancialReport
            from apps.inventory.models import InventoryStock, Warehouse, Location
