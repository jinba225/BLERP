...
from .viewsets import UserViewSet, RoleViewSet, UserRoleViewSet, PermissionViewSet, UserProfileViewSet, LoginLogViewSet
from . import views
...
urlpatterns = [
    ...
    path('roles/<int:pk>/remove-user/<int:user_id>/', views.role_remove_user, name='role_remove_user'),
