...
# SVG 图标
SUCCESS_ICON = (
    '<svg class="icon-success" viewBox="0 0 20 20">'
    '<path fill="currentColor" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414'
    'L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"/></svg>'
)
ERROR_ICON = (
    '<svg class="icon-error" viewBox="0 0 20 20">'
    '<path fill="currentColor" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414'
    "L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414"
    'L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z"/></svg>'
)
...
class ChannelAdapter:
    ...
    def _format_telegram(self, content: str, message: IncomingMessage) -> OutgoingMessage:
        ...
        return OutgoingMessage(content=formatted, message_type="text", extra=extra)
    ...
    def _format_wechat(self, content: str, message: IncomingMessage) -> OutgoingMessage:
        ...
        extra = {"msgtype": "markdown", "markdown": {"content": formatted}}
        return OutgoingMessage(content=formatted, message_type="text", extra=extra)
    ...
    def _format_dingtalk(self, content: str, message: IncomingMessage) -> OutgoingMessage:
        ...
        extra = {"msg": {"msgtype": "markdown", "text": formatted}}
        return OutgoingMessage(content=content, message_type="text", extra=extra)
    ...
    def format_error_message(self, error: str, platform: str) -> OutgoingMessage:
        ...
        return OutgoingMessage(content=formatted, message_type="text")

    def format_confirmation_message(
        self, message: str, platform: str = "telegram"
    ) -> OutgoingMessage:
        """
        格式化确认消息
        ...
        if platform == "telegram":
            ...
            return OutgoingMessage(content=f"{SUCCESS_ICON} {message}", message_type="text")

    def format_tool_result(
        self, result: Dict[str, Any], platform: str = "telegram"
    ) -> OutgoingMessage:
        """
        格式化工具执行结果
