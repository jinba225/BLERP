...
urlpatterns = [
    ...
    path('settings/ai-models/<int:pk>/delete/', views.model_config_delete, name='model_config_delete'),
    path('settings/ai-models/<int:pk>/test/', views.model_config_test, name='model_config_test'),
    path('settings/ai-models/<int:pk>/set-default/', views.model_config_set_default, name='model_config_set_default'),
