...
urlpatterns = [
    ...
    path(
        "settings/ai-models/create/",
        views.model_config_create,
        name="model_config_create",
    ),
    path(
        "settings/ai-models/<int:pk>/edit/",
        views.model_config_edit,
        name="model_config_edit",
    ),
    path(
        "settings/ai-models/<int:pk>/delete/",
        views.model_config_delete,
        name="model_config_delete",
    ),
    path(
        "settings/ai-models/<int:pk>/test/",
        views.model_config_test,
