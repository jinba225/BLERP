...
def process_message_async(self, message_data: dict, user_id: int):
    ...
    try:
        ...
        from apps.ai_assistant.channels.base_channel import IncomingMessage
        from apps.ai_assistant.channels.message_handler import MessageHandler
...
def cleanup_old_logs():
    ...
    """
    try:
        from apps.ai_assistant.models import AIToolExecutionLog
