...
class ToolExecutionTest(TestCase):
    ...
    def test_customer_search_tool(self):
        """测试客户搜索工具"""
        from ai_assistant.tools import ToolRegistry, SearchCustomerTool
    ...
    def test_product_search_tool(self):
        """测试产品搜索工具"""
        from ai_assistant.tools import ToolRegistry, SearchProductTool
    ...
    def test_inventory_check_tool(self):
        """测试库存检查工具"""
        from ai_assistant.tools import ToolRegistry, CheckInventoryTool
    ...
    def test_low_stock_alert_tool(self):
        """测试低库存预警工具"""
        from ai_assistant.tools import ToolRegistry, GetLowStockAlertTool
...
class MultiChannelIntegrationTest(TestCase):
    ...
    def test_conversation_context_management(self):
        """测试对话上下文管理"""
        from ai_assistant.services import NLPService, ConversationFlowManager
        from ai_assistant.channels import IncomingMessage
        from ai_assistant.services import NLPService
