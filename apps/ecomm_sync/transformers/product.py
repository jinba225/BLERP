...
from apps.ecomm_sync.models import EcommProduct
from apps.products.models import (
    Product, ProductCategory, Brand, Unit
)
...
class ProductTransformer:
    ...
    @staticmethod
    def sync_category(raw_data: Dict, parent_category: Optional[ProductCategory] = None) -> ProductCategory:
        """
        同步或创建分类
