...
class ShopeeAdapter(BaseAdapter):
    ...
    def _generate_signature(self, path: str, params: Dict, body: str = "") -> str:
        ...
        base_string = (
            f"{self.partner_id}{path}{query_string}{params['timestamp']}{self.partner_key}"
        )
    ...
    def get_order(self, order_id: str) -> Dict:
        """获取单个订单"""
        params = {"shop_id": self.shop_id, "ordersn_list": f"[{order_id}]"}
    ...
    def update_order_status(self, order_id: str, status: str, tracking_number: str = None) -> bool:
        """更新订单状态"""
        params = {"shop_id": self.shop_id, "ordersn": order_id}
    ...
    def get_product(self, product_id: str) -> Dict:
        """获取单个商品"""
        params = {"shop_id": self.shop_id, "item_id_list": f"[{product_id}]"}
    ...
    def update_product(self, product_id: str, product_data: Dict) -> Dict:
        """更新商品"""
        params = {"shop_id": self.shop_id, "item_id": product_id}
