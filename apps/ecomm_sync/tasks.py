...
def sync_platform_products_task(self, platform_id: int, strategy_type: str = 'incremental'):
    ...
    """
    from apps.ecomm_sync.models import EcommPlatform
    from apps.ecomm_sync.services.sync_manager import SyncManager
...
def test_scraper_task(self, platform_id: int):
    ...
    """
    from apps.ecomm_sync.models import EcommPlatform
    from apps.ecomm_sync.scrapers.hybrid import HybridScraper
