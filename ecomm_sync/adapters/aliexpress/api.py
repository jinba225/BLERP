...
class AliexpressAdapter(BaseAdapter):
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            response = self._make_request('GET', '/param2/1/aliexpress/solution/order/info/query', params=params)
    ...
    def get_orders(self, start_date=None, end_date=None, **filters) -> List[Dict]:
        ...
        order_statuses = filters.get('order_statuses', ['place_order_success', 'in_payment', 'in_cancel', 'wait_seller_send_goods'])
    ...
    def get_order(self, order_id: str) -> Dict:
        ...
        response = self._make_request('GET', '/param2/1/aliexpress/solution/order/detail/query', params=params)
    ...
    def update_order_status(self, order_id: str, status: str, tracking_number: str = None) -> bool:
        ...
        try:
            ...
            response = self._make_request('POST', '/param2/1/aliexpress/solution/order/info/seller/ship', data=params)
    ...
    def get_products(self, **filters) -> List[Dict]:
        ...
        response = self._make_request('GET', '/param2/1/aliexpress/solution/product/info/query', params=params)
