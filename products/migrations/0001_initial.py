    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('barcode', models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='条形码')),
                ('product_type', models.CharField(choices=[('material', '原材料'), ('semi_finished', '半成品'), ('finished', '成品'), ('service', '服务'), ('virtual', '虚拟产品')], default='finished', max_length=20, verbose_name='产品类型')),
                ('status', models.CharField(choices=[('active', '正常'), ('inactive', '停用'), ('discontinued', '停产'), ('development', '开发中')], default='active', max_length=20, verbose_name='状态')),
                ...
                ('cost_price', models.DecimalField(decimal_places=2, default=0, max_digits=12, validators=[django.core.validators.MinValueValidator(0)], verbose_name='成本价')),
                ('selling_price', models.DecimalField(decimal_places=2, default=0, max_digits=12, validators=[django.core.validators.MinValueValidator(0)], verbose_name='销售价')),
                ...
                ('main_image', models.ImageField(blank=True, upload_to='products/', verbose_name='主图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute_type', models.CharField(choices=[('text', '文本'), ('number', '数字'), ('boolean', '布尔值'), ('date', '日期'), ('choice', '选择')], default='text', max_length=20, verbose_name='属性类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(default=False, verbose_name='是否删除')),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='删除时间')),
                ('price_type', models.CharField(choices=[('cost', '成本价'), ('selling', '销售价'), ('wholesale', '批发价'), ('retail', '零售价')], max_length=20, verbose_name='价格类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_type', models.CharField(choices=[('basic', '基本单位'), ('weight', '重量单位'), ('length', '长度单位'), ('area', '面积单位'), ('volume', '体积单位'), ('time', '时间单位'), ('count', '计数单位')], default='basic', max_length=20, verbose_name='单位类型')),
