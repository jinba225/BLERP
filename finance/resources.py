...
class ExpenseResource(resources.ModelResource):
    ...
    class Meta:
        model = Expense
        fields = (
            'id', 'expense_number', 'expense_date', 'applicant', 'department',
            'category', 'amount', 'payment_method', 'description', 'status',
            'approved_by', 'approved_at', 'approval_note',
            'paid_by', 'paid_at', 'payment_account',
...
class InvoiceResource(resources.ModelResource):
    ...
    class Meta:
        ...
        fields = (
            ...
            'customer', 'supplier', 'total_amount', 'tax_amount', 'tax_rate',
...
class PaymentResource(resources.ModelResource):
    ...
    class Meta:
        ...
        fields = (
            ...
            'customer', 'supplier', 'amount', 'currency', 'payment_method',
            'status', 'bank_account', 'bank_name', 'transaction_reference',
            'notes',
            'created_at', 'updated_at'
        )
        export_order = fields
...
class JournalResource(resources.ModelResource):
    ...
    class Meta:
        model = Journal
        fields = (
            'id', 'journal_number', 'journal_type', 'journal_date',
...
class JournalEntryResource(resources.ModelResource):
    ...
    class Meta:
        model = JournalEntry
        fields = (
            'id', 'journal', 'account', 'debit_amount', 'credit_amount',
